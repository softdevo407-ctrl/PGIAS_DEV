      ...
      <div className="container-fluid px-4">
        ...
        <div className="row mb-5">
          <div className="col-md-8">
            <h1 className="fw-bold text-dark mb-2" style={{ fontSize: '2.5rem' }}>Screens</h1>
            <p className="text-muted fs-5">Manage application screens and forms</p>
          </div>
          ...
          <div className="card-body p-0">
            ...
            {loading ? (
              <div className="text-center py-5">
                ...
                <p className="mt-3 text-muted">Loading screens...</p>
              </div>
            ) : paginatedData.length === 0 ? (
              <div className="text-center py-5">
                <p className="text-muted fs-5">No screens found</p>
              </div>
            ) : (
              <>
